...
def test_K_under_epsilon_corrected():
    ns = [100, 1000, 10000, 100000, 1000000, 10000000]  # 修改：添加更大的 n=10000000
    ...
    for n in ns:
        ...
        print(f"         | ρ(n) ≈ {mp.nstr(approx, 50)}")  # 修改：显示 50 位以查看更多正确位
